...
const formatMovementDate = function (date, locale) {
  // Calculate the days that have passed from today and the movement date
  ...
  // If the date is more than 7 days ago, then format the date according to user's locale
